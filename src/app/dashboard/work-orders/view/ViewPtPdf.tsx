...
import { MdOutlineAbc, MdEmail, MdOutlineFilePresent } from "react-icons/md";
import { getPreticketdf } from "@/lib";
import { ScrollArea } from "@/ui";
import { handleForm } from "@/lib";
import PdfModal from "./PdfModal";

function ViewPreticketPdf({ preticketId, customer }: any) {
  ...
  function handleClickPdf(toId: string) {
    ...
    (async () => {
      ...
      const result = await getPreticketdf(token, toId);
  ...
  return (
    <div className="flex">
      <Button
        onClick={() => handleClickPdf(preticketId)}
        variant="outline"
...
export default ViewPreticketPdf;
